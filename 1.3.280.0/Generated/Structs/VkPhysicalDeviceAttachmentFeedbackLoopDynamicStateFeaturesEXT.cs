...
namespace VkSharp
{
    ...
    public unsafe partial struct VkPhysicalDeviceAttachmentFeedbackLoopDynamicStateFeaturesEXT
    {
        ...
        public const VkStructureType StructureTypeId = VkStructureType.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_ATTACHMENT_FEEDBACK_LOOP_DYNAMIC_STATE_FEATURES_EXT;
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static VkPhysicalDeviceAttachmentFeedbackLoopDynamicStateFeaturesEXT Create()
        {
            VkPhysicalDeviceAttachmentFeedbackLoopDynamicStateFeaturesEXT ret = default;
