...
namespace VkSharp
{
    public static unsafe partial class VkDelegates
    {
        ...
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate VkResult vkGetPhysicalDeviceToolPropertiesDelegate(VkPhysicalDevice physicalDevice, ref uint pToolCount, VkPhysicalDeviceToolProperties* pToolProperties);
        
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate VkResult vkCreatePrivateDataSlotDelegate(VkDevice device, in VkPrivateDataSlotCreateInfo pCreateInfo, in VkAllocationCallbacks pAllocator, ref VkPrivateDataSlot pPrivateDataSlot);
        
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate void vkDestroyPrivateDataSlotDelegate(VkDevice device, VkPrivateDataSlot privateDataSlot, in VkAllocationCallbacks pAllocator);
        
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate VkResult vkSetPrivateDataDelegate(VkDevice device, VkObjectType objectType, ulong objectHandle, VkPrivateDataSlot privateDataSlot, ulong data);
        
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate void vkGetPrivateDataDelegate(VkDevice device, VkObjectType objectType, ulong objectHandle, VkPrivateDataSlot privateDataSlot, ref ulong pData);
        
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate void vkCmdSetEvent2Delegate(VkCommandBuffer commandBuffer, VkEvent _event, in VkDependencyInfo pDependencyInfo);
        
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate void vkCmdResetEvent2Delegate(VkCommandBuffer commandBuffer, VkEvent _event, VkPipelineStageFlags2 stageMask);
        
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate void vkCmdWaitEvents2Delegate(VkCommandBuffer commandBuffer, uint eventCount, VkEvent* pEvents, in VkDependencyInfo pDependencyInfos);
        
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate void vkCmdPipelineBarrier2Delegate(VkCommandBuffer commandBuffer, in VkDependencyInfo pDependencyInfo);
        
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate void vkCmdWriteTimestamp2Delegate(VkCommandBuffer commandBuffer, VkPipelineStageFlags2 stage, VkQueryPool queryPool, uint query);
        
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate VkResult vkQueueSubmit2Delegate(VkQueue queue, uint submitCount, VkSubmitInfo2* pSubmits, VkFence fence);
        
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate void vkCmdCopyBuffer2Delegate(VkCommandBuffer commandBuffer, in VkCopyBufferInfo2 pCopyBufferInfo);
        
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate void vkCmdCopyImage2Delegate(VkCommandBuffer commandBuffer, in VkCopyImageInfo2 pCopyImageInfo);
        
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate void vkCmdCopyBufferToImage2Delegate(VkCommandBuffer commandBuffer, in VkCopyBufferToImageInfo2 pCopyBufferToImageInfo);
        
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate void vkCmdCopyImageToBuffer2Delegate(VkCommandBuffer commandBuffer, in VkCopyImageToBufferInfo2 pCopyImageToBufferInfo);
        
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate void vkCmdBlitImage2Delegate(VkCommandBuffer commandBuffer, in VkBlitImageInfo2 pBlitImageInfo);
        
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate void vkCmdResolveImage2Delegate(VkCommandBuffer commandBuffer, in VkResolveImageInfo2 pResolveImageInfo);
        
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate void vkCmdBeginRenderingDelegate(VkCommandBuffer commandBuffer, in VkRenderingInfo pRenderingInfo);
        
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate void vkCmdEndRenderingDelegate(VkCommandBuffer commandBuffer);
        
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate void vkCmdSetCullModeDelegate(VkCommandBuffer commandBuffer, VkCullModeFlags cullMode);
        
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate void vkCmdSetFrontFaceDelegate(VkCommandBuffer commandBuffer, VkFrontFace frontFace);
        
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate void vkCmdSetPrimitiveTopologyDelegate(VkCommandBuffer commandBuffer, VkPrimitiveTopology primitiveTopology);
        
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate void vkCmdSetViewportWithCountDelegate(VkCommandBuffer commandBuffer, uint viewportCount, VkViewport* pViewports);
        
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate void vkCmdSetScissorWithCountDelegate(VkCommandBuffer commandBuffer, uint scissorCount, VkRect2D* pScissors);
        
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate void vkCmdBindVertexBuffers2Delegate(VkCommandBuffer commandBuffer, uint firstBinding, uint bindingCount, VkBuffer* pBuffers, in ulong pOffsets, in ulong pSizes, in ulong pStrides);
        
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate void vkCmdSetDepthTestEnableDelegate(VkCommandBuffer commandBuffer, VkBool32 depthTestEnable);
        
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate void vkCmdSetDepthWriteEnableDelegate(VkCommandBuffer commandBuffer, VkBool32 depthWriteEnable);
        
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate void vkCmdSetDepthCompareOpDelegate(VkCommandBuffer commandBuffer, VkCompareOp depthCompareOp);
        
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate void vkCmdSetDepthBoundsTestEnableDelegate(VkCommandBuffer commandBuffer, VkBool32 depthBoundsTestEnable);
        
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate void vkCmdSetStencilTestEnableDelegate(VkCommandBuffer commandBuffer, VkBool32 stencilTestEnable);
        
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate void vkCmdSetStencilOpDelegate(VkCommandBuffer commandBuffer, VkStencilFaceFlags faceMask, VkStencilOp failOp, VkStencilOp passOp, VkStencilOp depthFailOp, VkCompareOp compareOp);
        
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate void vkCmdSetRasterizerDiscardEnableDelegate(VkCommandBuffer commandBuffer, VkBool32 rasterizerDiscardEnable);
        
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate void vkCmdSetDepthBiasEnableDelegate(VkCommandBuffer commandBuffer, VkBool32 depthBiasEnable);
        
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate void vkCmdSetPrimitiveRestartEnableDelegate(VkCommandBuffer commandBuffer, VkBool32 primitiveRestartEnable);
        
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate void vkGetDeviceBufferMemoryRequirementsDelegate(VkDevice device, in VkDeviceBufferMemoryRequirements pInfo, ref VkMemoryRequirements2 pMemoryRequirements);
        
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate void vkGetDeviceImageMemoryRequirementsDelegate(VkDevice device, in VkDeviceImageMemoryRequirements pInfo, ref VkMemoryRequirements2 pMemoryRequirements);
        
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate void vkGetDeviceImageSparseMemoryRequirementsDelegate(VkDevice device, in VkDeviceImageMemoryRequirements pInfo, ref uint pSparseMemoryRequirementCount, VkSparseImageMemoryRequirements2* pSparseMemoryRequirements);
        ...
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate VkResult vkGetPhysicalDeviceVideoCapabilitiesKHRDelegate(VkPhysicalDevice physicalDevice, in VkVideoProfileInfoKHR pVideoProfile, ref VkVideoCapabilitiesKHR pCapabilities);
        
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate VkResult vkGetPhysicalDeviceVideoFormatPropertiesKHRDelegate(VkPhysicalDevice physicalDevice, in VkPhysicalDeviceVideoFormatInfoKHR pVideoFormatInfo, ref uint pVideoFormatPropertyCount, VkVideoFormatPropertiesKHR* pVideoFormatProperties);
        
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate VkResult vkCreateVideoSessionKHRDelegate(VkDevice device, in VkVideoSessionCreateInfoKHR pCreateInfo, in VkAllocationCallbacks pAllocator, ref VkVideoSessionKHR pVideoSession);
        
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate void vkDestroyVideoSessionKHRDelegate(VkDevice device, VkVideoSessionKHR videoSession, in VkAllocationCallbacks pAllocator);
        
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate VkResult vkGetVideoSessionMemoryRequirementsKHRDelegate(VkDevice device, VkVideoSessionKHR videoSession, ref uint pMemoryRequirementsCount, VkVideoSessionMemoryRequirementsKHR* pMemoryRequirements);
        
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate VkResult vkBindVideoSessionMemoryKHRDelegate(VkDevice device, VkVideoSessionKHR videoSession, uint bindSessionMemoryInfoCount, VkBindVideoSessionMemoryInfoKHR* pBindSessionMemoryInfos);
        
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate VkResult vkCreateVideoSessionParametersKHRDelegate(VkDevice device, in VkVideoSessionParametersCreateInfoKHR pCreateInfo, in VkAllocationCallbacks pAllocator, ref VkVideoSessionParametersKHR pVideoSessionParameters);
        
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate VkResult vkUpdateVideoSessionParametersKHRDelegate(VkDevice device, VkVideoSessionParametersKHR videoSessionParameters, in VkVideoSessionParametersUpdateInfoKHR pUpdateInfo);
        
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate void vkDestroyVideoSessionParametersKHRDelegate(VkDevice device, VkVideoSessionParametersKHR videoSessionParameters, in VkAllocationCallbacks pAllocator);
        
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate void vkCmdBeginVideoCodingKHRDelegate(VkCommandBuffer commandBuffer, in VkVideoBeginCodingInfoKHR pBeginInfo);
        
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate void vkCmdEndVideoCodingKHRDelegate(VkCommandBuffer commandBuffer, in VkVideoEndCodingInfoKHR pEndCodingInfo);
        
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate void vkCmdControlVideoCodingKHRDelegate(VkCommandBuffer commandBuffer, in VkVideoCodingControlInfoKHR pCodingControlInfo);
        
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate void vkCmdDecodeVideoKHRDelegate(VkCommandBuffer commandBuffer, in VkVideoDecodeInfoKHR pDecodeInfo);
        
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate void vkCmdBeginRenderingKHRDelegate(VkCommandBuffer commandBuffer, in VkRenderingInfo pRenderingInfo);
        ...
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate void vkCmdSetRenderingAttachmentLocationsKHRDelegate(VkCommandBuffer commandBuffer, in VkRenderingAttachmentLocationInfoKHR pLocationInfo);
        
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate void vkCmdSetRenderingInputAttachmentIndicesKHRDelegate(VkCommandBuffer commandBuffer, in VkRenderingInputAttachmentIndexInfoKHR pLocationInfo);
        ...
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate VkResult vkMapMemory2KHRDelegate(VkDevice device, in VkMemoryMapInfoKHR pMemoryMapInfo, ref void* ppData);
        
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate VkResult vkUnmapMemory2KHRDelegate(VkDevice device, in VkMemoryUnmapInfoKHR pMemoryUnmapInfo);
        
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate VkResult vkGetPhysicalDeviceVideoEncodeQualityLevelPropertiesKHRDelegate(VkPhysicalDevice physicalDevice, in VkPhysicalDeviceVideoEncodeQualityLevelInfoKHR pQualityLevelInfo, ref VkVideoEncodeQualityLevelPropertiesKHR pQualityLevelProperties);
        
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate VkResult vkGetEncodedVideoSessionParametersKHRDelegate(VkDevice device, in VkVideoEncodeSessionParametersGetInfoKHR pVideoSessionParametersInfo, ref VkVideoEncodeSessionParametersFeedbackInfoKHR pFeedbackInfo, ref ulong pDataSize, void* pData);
        
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate void vkCmdEncodeVideoKHRDelegate(VkCommandBuffer commandBuffer, in VkVideoEncodeInfoKHR pEncodeInfo);
        
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate void vkCmdSetEvent2KHRDelegate(VkCommandBuffer commandBuffer, VkEvent _event, in VkDependencyInfo pDependencyInfo);
        
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate void vkCmdResetEvent2KHRDelegate(VkCommandBuffer commandBuffer, VkEvent _event, VkPipelineStageFlags2 stageMask);
        
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate void vkCmdWaitEvents2KHRDelegate(VkCommandBuffer commandBuffer, uint eventCount, VkEvent* pEvents, in VkDependencyInfo pDependencyInfos);
        
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate void vkCmdPipelineBarrier2KHRDelegate(VkCommandBuffer commandBuffer, in VkDependencyInfo pDependencyInfo);
        
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate void vkCmdWriteTimestamp2KHRDelegate(VkCommandBuffer commandBuffer, VkPipelineStageFlags2 stage, VkQueryPool queryPool, uint query);
        
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate VkResult vkQueueSubmit2KHRDelegate(VkQueue queue, uint submitCount, VkSubmitInfo2* pSubmits, VkFence fence);
        
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate void vkCmdWriteBufferMarker2AMDDelegate(VkCommandBuffer commandBuffer, VkPipelineStageFlags2 stage, VkBuffer dstBuffer, ulong dstOffset, uint marker);
        ...
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate void vkCmdCopyBuffer2KHRDelegate(VkCommandBuffer commandBuffer, in VkCopyBufferInfo2 pCopyBufferInfo);
        
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate void vkCmdCopyImage2KHRDelegate(VkCommandBuffer commandBuffer, in VkCopyImageInfo2 pCopyImageInfo);
        
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate void vkCmdCopyBufferToImage2KHRDelegate(VkCommandBuffer commandBuffer, in VkCopyBufferToImageInfo2 pCopyBufferToImageInfo);
        
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate void vkCmdCopyImageToBuffer2KHRDelegate(VkCommandBuffer commandBuffer, in VkCopyImageToBufferInfo2 pCopyImageToBufferInfo);
        
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate void vkCmdBlitImage2KHRDelegate(VkCommandBuffer commandBuffer, in VkBlitImageInfo2 pBlitImageInfo);
        
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate void vkCmdResolveImage2KHRDelegate(VkCommandBuffer commandBuffer, in VkResolveImageInfo2 pResolveImageInfo);
        
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate void vkCmdTraceRaysIndirect2KHRDelegate(VkCommandBuffer commandBuffer, ulong indirectDeviceAddress);
        
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate void vkGetDeviceBufferMemoryRequirementsKHRDelegate(VkDevice device, in VkDeviceBufferMemoryRequirements pInfo, ref VkMemoryRequirements2 pMemoryRequirements);
        
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate void vkGetDeviceImageMemoryRequirementsKHRDelegate(VkDevice device, in VkDeviceImageMemoryRequirements pInfo, ref VkMemoryRequirements2 pMemoryRequirements);
        
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate void vkGetDeviceImageSparseMemoryRequirementsKHRDelegate(VkDevice device, in VkDeviceImageMemoryRequirements pInfo, ref uint pSparseMemoryRequirementCount, VkSparseImageMemoryRequirements2* pSparseMemoryRequirements);
        
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate void vkCmdBindIndexBuffer2KHRDelegate(VkCommandBuffer commandBuffer, VkBuffer buffer, ulong offset, ulong size, VkIndexType indexType);
        
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate void vkGetRenderingAreaGranularityKHRDelegate(VkDevice device, in VkRenderingAreaInfoKHR pRenderingAreaInfo, ref VkExtent2D pGranularity);
        
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate void vkGetDeviceImageSubresourceLayoutKHRDelegate(VkDevice device, in VkDeviceImageSubresourceInfoKHR pInfo, ref VkSubresourceLayout2KHR pLayout);
        
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate void vkGetImageSubresourceLayout2KHRDelegate(VkDevice device, VkImage image, in VkImageSubresource2KHR pSubresource, ref VkSubresourceLayout2KHR pLayout);
        
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate VkResult vkGetPhysicalDeviceCooperativeMatrixPropertiesKHRDelegate(VkPhysicalDevice physicalDevice, ref uint pPropertyCount, VkCooperativeMatrixPropertiesKHR* pProperties);
        
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate void vkCmdSetLineStippleKHRDelegate(VkCommandBuffer commandBuffer, uint lineStippleFactor, ushort lineStipplePattern);
        
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate VkResult vkGetPhysicalDeviceCalibrateableTimeDomainsKHRDelegate(VkPhysicalDevice physicalDevice, ref uint pTimeDomainCount, VkTimeDomainKHR* pTimeDomains);
        
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate VkResult vkGetCalibratedTimestampsKHRDelegate(VkDevice device, uint timestampCount, in VkCalibratedTimestampInfoKHR pTimestampInfos, ulong* pTimestamps, ref ulong pMaxDeviation);
        
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate void vkCmdBindDescriptorSets2KHRDelegate(VkCommandBuffer commandBuffer, in VkBindDescriptorSetsInfoKHR pBindDescriptorSetsInfo);
        
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate void vkCmdPushConstants2KHRDelegate(VkCommandBuffer commandBuffer, in VkPushConstantsInfoKHR pPushConstantsInfo);
        
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate void vkCmdPushDescriptorSet2KHRDelegate(VkCommandBuffer commandBuffer, in VkPushDescriptorSetInfoKHR pPushDescriptorSetInfo);
        
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate void vkCmdPushDescriptorSetWithTemplate2KHRDelegate(VkCommandBuffer commandBuffer, in VkPushDescriptorSetWithTemplateInfoKHR pPushDescriptorSetWithTemplateInfo);
        
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate void vkCmdSetDescriptorBufferOffsets2EXTDelegate(VkCommandBuffer commandBuffer, in VkSetDescriptorBufferOffsetsInfoEXT pSetDescriptorBufferOffsetsInfo);
        
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate void vkCmdBindDescriptorBufferEmbeddedSamplers2EXTDelegate(VkCommandBuffer commandBuffer, in VkBindDescriptorBufferEmbeddedSamplersInfoEXT pBindDescriptorBufferEmbeddedSamplersInfo);
        ...
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate void vkCmdSetDiscardRectangleEnableEXTDelegate(VkCommandBuffer commandBuffer, VkBool32 discardRectangleEnable);
        
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate void vkCmdSetDiscardRectangleModeEXTDelegate(VkCommandBuffer commandBuffer, VkDiscardRectangleModeEXT discardRectangleMode);
        ...
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate VkResult vkGetPhysicalDeviceCalibrateableTimeDomainsEXTDelegate(VkPhysicalDevice physicalDevice, ref uint pTimeDomainCount, VkTimeDomainKHR* pTimeDomains);
        
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate VkResult vkGetCalibratedTimestampsEXTDelegate(VkDevice device, uint timestampCount, in VkCalibratedTimestampInfoKHR pTimestampInfos, ulong* pTimestamps, ref ulong pMaxDeviation);
        ...
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate void vkCmdSetExclusiveScissorEnableNVDelegate(VkCommandBuffer commandBuffer, uint firstExclusiveScissor, uint exclusiveScissorCount, VkBool32* pExclusiveScissorEnables);
        ...
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate VkResult vkGetPhysicalDeviceToolPropertiesEXTDelegate(VkPhysicalDevice physicalDevice, ref uint pToolCount, VkPhysicalDeviceToolProperties* pToolProperties);
        ...
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate VkResult vkCopyMemoryToImageEXTDelegate(VkDevice device, in VkCopyMemoryToImageInfoEXT pCopyMemoryToImageInfo);
        
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate VkResult vkCopyImageToMemoryEXTDelegate(VkDevice device, in VkCopyImageToMemoryInfoEXT pCopyImageToMemoryInfo);
        
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate VkResult vkCopyImageToImageEXTDelegate(VkDevice device, in VkCopyImageToImageInfoEXT pCopyImageToImageInfo);
        
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate VkResult vkTransitionImageLayoutEXTDelegate(VkDevice device, uint transitionCount, VkHostImageLayoutTransitionInfoEXT* pTransitions);
        
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate void vkGetImageSubresourceLayout2EXTDelegate(VkDevice device, VkImage image, in VkImageSubresource2KHR pSubresource, ref VkSubresourceLayout2KHR pLayout);
        
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate VkResult vkReleaseSwapchainImagesEXTDelegate(VkDevice device, in VkReleaseSwapchainImagesInfoEXT pReleaseInfo);
        ...
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate void vkCmdSetDepthBias2EXTDelegate(VkCommandBuffer commandBuffer, in VkDepthBiasInfoEXT pDepthBiasInfo);
        ...
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate VkResult vkCreatePrivateDataSlotEXTDelegate(VkDevice device, in VkPrivateDataSlotCreateInfo pCreateInfo, in VkAllocationCallbacks pAllocator, ref VkPrivateDataSlot pPrivateDataSlot);
        
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate void vkDestroyPrivateDataSlotEXTDelegate(VkDevice device, VkPrivateDataSlot privateDataSlot, in VkAllocationCallbacks pAllocator);
        
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate VkResult vkSetPrivateDataEXTDelegate(VkDevice device, VkObjectType objectType, ulong objectHandle, VkPrivateDataSlot privateDataSlot, ulong data);
        
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate void vkGetPrivateDataEXTDelegate(VkDevice device, VkObjectType objectType, ulong objectHandle, VkPrivateDataSlot privateDataSlot, ref ulong pData);
        
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate VkResult vkCreateCudaModuleNVDelegate(VkDevice device, in VkCudaModuleCreateInfoNV pCreateInfo, in VkAllocationCallbacks pAllocator, ref VkCudaModuleNV pModule);
        
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate VkResult vkGetCudaModuleCacheNVDelegate(VkDevice device, VkCudaModuleNV module, ref ulong pCacheSize, void* pCacheData);
        
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate VkResult vkCreateCudaFunctionNVDelegate(VkDevice device, in VkCudaFunctionCreateInfoNV pCreateInfo, in VkAllocationCallbacks pAllocator, ref VkCudaFunctionNV pFunction);
        
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate void vkDestroyCudaModuleNVDelegate(VkDevice device, VkCudaModuleNV module, in VkAllocationCallbacks pAllocator);
        
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate void vkDestroyCudaFunctionNVDelegate(VkDevice device, VkCudaFunctionNV function, in VkAllocationCallbacks pAllocator);
        
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate void vkCmdCudaLaunchKernelNVDelegate(VkCommandBuffer commandBuffer, in VkCudaLaunchInfoNV pLaunchInfo);
        
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate void vkGetDescriptorSetLayoutSizeEXTDelegate(VkDevice device, VkDescriptorSetLayout layout, ref ulong pLayoutSizeInBytes);
        
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate void vkGetDescriptorSetLayoutBindingOffsetEXTDelegate(VkDevice device, VkDescriptorSetLayout layout, uint binding, ref ulong pOffset);
        
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate void vkGetDescriptorEXTDelegate(VkDevice device, in VkDescriptorGetInfoEXT pDescriptorInfo, ulong dataSize, void* pDescriptor);
        
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate void vkCmdBindDescriptorBuffersEXTDelegate(VkCommandBuffer commandBuffer, uint bufferCount, VkDescriptorBufferBindingInfoEXT* pBindingInfos);
        
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate void vkCmdSetDescriptorBufferOffsetsEXTDelegate(VkCommandBuffer commandBuffer, VkPipelineBindPoint pipelineBindPoint, VkPipelineLayout layout, uint firstSet, uint setCount, in uint pBufferIndices, ulong* pOffsets);
        
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate void vkCmdBindDescriptorBufferEmbeddedSamplersEXTDelegate(VkCommandBuffer commandBuffer, VkPipelineBindPoint pipelineBindPoint, VkPipelineLayout layout, uint set);
        
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate VkResult vkGetBufferOpaqueCaptureDescriptorDataEXTDelegate(VkDevice device, in VkBufferCaptureDescriptorDataInfoEXT pInfo, void* pData);
        
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate VkResult vkGetImageOpaqueCaptureDescriptorDataEXTDelegate(VkDevice device, in VkImageCaptureDescriptorDataInfoEXT pInfo, void* pData);
        
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate VkResult vkGetImageViewOpaqueCaptureDescriptorDataEXTDelegate(VkDevice device, in VkImageViewCaptureDescriptorDataInfoEXT pInfo, void* pData);
        
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate VkResult vkGetSamplerOpaqueCaptureDescriptorDataEXTDelegate(VkDevice device, in VkSamplerCaptureDescriptorDataInfoEXT pInfo, void* pData);
        
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate VkResult vkGetAccelerationStructureOpaqueCaptureDescriptorDataEXTDelegate(VkDevice device, in VkAccelerationStructureCaptureDescriptorDataInfoEXT pInfo, void* pData);
        ...
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate VkResult vkGetDeviceFaultInfoEXTDelegate(VkDevice device, ref VkDeviceFaultCountsEXT pFaultCounts, ref VkDeviceFaultInfoEXT pFaultInfo);
        ...
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate VkResult vkGetPipelinePropertiesEXTDelegate(VkDevice device, in VkPipelineInfoKHR pPipelineInfo, ref VkBaseOutStructure pPipelineProperties);
        ...
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate VkResult vkCreateMicromapEXTDelegate(VkDevice device, in VkMicromapCreateInfoEXT pCreateInfo, in VkAllocationCallbacks pAllocator, ref VkMicromapEXT pMicromap);
        
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate void vkDestroyMicromapEXTDelegate(VkDevice device, VkMicromapEXT micromap, in VkAllocationCallbacks pAllocator);
        
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate void vkCmdBuildMicromapsEXTDelegate(VkCommandBuffer commandBuffer, uint infoCount, VkMicromapBuildInfoEXT* pInfos);
        
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate VkResult vkBuildMicromapsEXTDelegate(VkDevice device, VkDeferredOperationKHR deferredOperation, uint infoCount, VkMicromapBuildInfoEXT* pInfos);
        
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate VkResult vkCopyMicromapEXTDelegate(VkDevice device, VkDeferredOperationKHR deferredOperation, in VkCopyMicromapInfoEXT pInfo);
        
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate VkResult vkCopyMicromapToMemoryEXTDelegate(VkDevice device, VkDeferredOperationKHR deferredOperation, in VkCopyMicromapToMemoryInfoEXT pInfo);
        
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate VkResult vkCopyMemoryToMicromapEXTDelegate(VkDevice device, VkDeferredOperationKHR deferredOperation, in VkCopyMemoryToMicromapInfoEXT pInfo);
        
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate VkResult vkWriteMicromapsPropertiesEXTDelegate(VkDevice device, uint micromapCount, VkMicromapEXT* pMicromaps, VkQueryType queryType, ulong dataSize, void* pData, ulong stride);
        
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate void vkCmdCopyMicromapEXTDelegate(VkCommandBuffer commandBuffer, in VkCopyMicromapInfoEXT pInfo);
        
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate void vkCmdCopyMicromapToMemoryEXTDelegate(VkCommandBuffer commandBuffer, in VkCopyMicromapToMemoryInfoEXT pInfo);
        
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate void vkCmdCopyMemoryToMicromapEXTDelegate(VkCommandBuffer commandBuffer, in VkCopyMemoryToMicromapInfoEXT pInfo);
        
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate void vkCmdWriteMicromapsPropertiesEXTDelegate(VkCommandBuffer commandBuffer, uint micromapCount, VkMicromapEXT* pMicromaps, VkQueryType queryType, VkQueryPool queryPool, uint firstQuery);
        
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate void vkGetDeviceMicromapCompatibilityEXTDelegate(VkDevice device, in VkMicromapVersionInfoEXT pVersionInfo, ref VkAccelerationStructureCompatibilityKHR pCompatibility);
        
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate void vkGetMicromapBuildSizesEXTDelegate(VkDevice device, VkAccelerationStructureBuildTypeKHR buildType, in VkMicromapBuildInfoEXT pBuildInfo, ref VkMicromapBuildSizesInfoEXT pSizeInfo);
        
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate void vkCmdDrawClusterHUAWEIDelegate(VkCommandBuffer commandBuffer, uint groupCountX, uint groupCountY, uint groupCountZ);
        
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate void vkCmdDrawClusterIndirectHUAWEIDelegate(VkCommandBuffer commandBuffer, VkBuffer buffer, ulong offset);
        
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate void vkSetDeviceMemoryPriorityEXTDelegate(VkDevice device, VkDeviceMemory memory, float priority);
        
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate void vkGetDescriptorSetLayoutHostMappingInfoVALVEDelegate(VkDevice device, in VkDescriptorSetBindingReferenceVALVE pBindingReference, ref VkDescriptorSetLayoutHostMappingInfoVALVE pHostMapping);
        
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate void vkGetDescriptorSetHostMappingVALVEDelegate(VkDevice device, VkDescriptorSet descriptorSet, ref void* ppData);
        
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate void vkCmdCopyMemoryIndirectNVDelegate(VkCommandBuffer commandBuffer, ulong copyBufferAddress, uint copyCount, uint stride);
        
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate void vkCmdCopyMemoryToImageIndirectNVDelegate(VkCommandBuffer commandBuffer, ulong copyBufferAddress, uint copyCount, uint stride, VkImage dstImage, VkImageLayout dstImageLayout, VkImageSubresourceLayers* pImageSubresources);
        
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate void vkCmdDecompressMemoryNVDelegate(VkCommandBuffer commandBuffer, uint decompressRegionCount, VkDecompressMemoryRegionNV* pDecompressMemoryRegions);
        
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate void vkCmdDecompressMemoryIndirectCountNVDelegate(VkCommandBuffer commandBuffer, ulong indirectCommandsAddress, ulong indirectCommandsCountAddress, uint stride);
        
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate void vkGetPipelineIndirectMemoryRequirementsNVDelegate(VkDevice device, in VkComputePipelineCreateInfo pCreateInfo, ref VkMemoryRequirements2 pMemoryRequirements);
        
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate void vkCmdUpdatePipelineIndirectBufferNVDelegate(VkCommandBuffer commandBuffer, VkPipelineBindPoint pipelineBindPoint, VkPipeline pipeline);
        
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate ulong vkGetPipelineIndirectDeviceAddressNVDelegate(VkDevice device, in VkPipelineIndirectDeviceAddressInfoNV pInfo);
        
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate void vkCmdSetDepthClampEnableEXTDelegate(VkCommandBuffer commandBuffer, VkBool32 depthClampEnable);
        
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate void vkCmdSetPolygonModeEXTDelegate(VkCommandBuffer commandBuffer, VkPolygonMode polygonMode);
        
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate void vkCmdSetRasterizationSamplesEXTDelegate(VkCommandBuffer commandBuffer, VkSampleCountFlags rasterizationSamples);
        
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate void vkCmdSetSampleMaskEXTDelegate(VkCommandBuffer commandBuffer, VkSampleCountFlags samples, in uint pSampleMask);
        
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate void vkCmdSetAlphaToCoverageEnableEXTDelegate(VkCommandBuffer commandBuffer, VkBool32 alphaToCoverageEnable);
        
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate void vkCmdSetAlphaToOneEnableEXTDelegate(VkCommandBuffer commandBuffer, VkBool32 alphaToOneEnable);
        
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate void vkCmdSetLogicOpEnableEXTDelegate(VkCommandBuffer commandBuffer, VkBool32 logicOpEnable);
        
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate void vkCmdSetColorBlendEnableEXTDelegate(VkCommandBuffer commandBuffer, uint firstAttachment, uint attachmentCount, VkBool32* pColorBlendEnables);
        
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate void vkCmdSetColorBlendEquationEXTDelegate(VkCommandBuffer commandBuffer, uint firstAttachment, uint attachmentCount, VkColorBlendEquationEXT* pColorBlendEquations);
        
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate void vkCmdSetColorWriteMaskEXTDelegate(VkCommandBuffer commandBuffer, uint firstAttachment, uint attachmentCount, VkColorComponentFlags* pColorWriteMasks);
        
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate void vkCmdSetTessellationDomainOriginEXTDelegate(VkCommandBuffer commandBuffer, VkTessellationDomainOrigin domainOrigin);
        
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate void vkCmdSetRasterizationStreamEXTDelegate(VkCommandBuffer commandBuffer, uint rasterizationStream);
        
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate void vkCmdSetConservativeRasterizationModeEXTDelegate(VkCommandBuffer commandBuffer, VkConservativeRasterizationModeEXT conservativeRasterizationMode);
        
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate void vkCmdSetExtraPrimitiveOverestimationSizeEXTDelegate(VkCommandBuffer commandBuffer, float extraPrimitiveOverestimationSize);
        
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate void vkCmdSetDepthClipEnableEXTDelegate(VkCommandBuffer commandBuffer, VkBool32 depthClipEnable);
        
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate void vkCmdSetSampleLocationsEnableEXTDelegate(VkCommandBuffer commandBuffer, VkBool32 sampleLocationsEnable);
        
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate void vkCmdSetColorBlendAdvancedEXTDelegate(VkCommandBuffer commandBuffer, uint firstAttachment, uint attachmentCount, VkColorBlendAdvancedEXT* pColorBlendAdvanced);
        
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate void vkCmdSetProvokingVertexModeEXTDelegate(VkCommandBuffer commandBuffer, VkProvokingVertexModeEXT provokingVertexMode);
        
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate void vkCmdSetLineRasterizationModeEXTDelegate(VkCommandBuffer commandBuffer, VkLineRasterizationModeKHR lineRasterizationMode);
        
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate void vkCmdSetLineStippleEnableEXTDelegate(VkCommandBuffer commandBuffer, VkBool32 stippledLineEnable);
        
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate void vkCmdSetDepthClipNegativeOneToOneEXTDelegate(VkCommandBuffer commandBuffer, VkBool32 negativeOneToOne);
        
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate void vkCmdSetViewportWScalingEnableNVDelegate(VkCommandBuffer commandBuffer, VkBool32 viewportWScalingEnable);
        
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate void vkCmdSetViewportSwizzleNVDelegate(VkCommandBuffer commandBuffer, uint firstViewport, uint viewportCount, VkViewportSwizzleNV* pViewportSwizzles);
        
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate void vkCmdSetCoverageToColorEnableNVDelegate(VkCommandBuffer commandBuffer, VkBool32 coverageToColorEnable);
        
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate void vkCmdSetCoverageToColorLocationNVDelegate(VkCommandBuffer commandBuffer, uint coverageToColorLocation);
        
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate void vkCmdSetCoverageModulationModeNVDelegate(VkCommandBuffer commandBuffer, VkCoverageModulationModeNV coverageModulationMode);
        
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate void vkCmdSetCoverageModulationTableEnableNVDelegate(VkCommandBuffer commandBuffer, VkBool32 coverageModulationTableEnable);
        
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate void vkCmdSetCoverageModulationTableNVDelegate(VkCommandBuffer commandBuffer, uint coverageModulationTableCount, float* pCoverageModulationTable);
        
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate void vkCmdSetShadingRateImageEnableNVDelegate(VkCommandBuffer commandBuffer, VkBool32 shadingRateImageEnable);
        
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate void vkCmdSetRepresentativeFragmentTestEnableNVDelegate(VkCommandBuffer commandBuffer, VkBool32 representativeFragmentTestEnable);
        
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate void vkCmdSetCoverageReductionModeNVDelegate(VkCommandBuffer commandBuffer, VkCoverageReductionModeNV coverageReductionMode);
        
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate void vkGetShaderModuleIdentifierEXTDelegate(VkDevice device, VkShaderModule shaderModule, ref VkShaderModuleIdentifierEXT pIdentifier);
        
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate void vkGetShaderModuleCreateInfoIdentifierEXTDelegate(VkDevice device, in VkShaderModuleCreateInfo pCreateInfo, ref VkShaderModuleIdentifierEXT pIdentifier);
        
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate VkResult vkGetPhysicalDeviceOpticalFlowImageFormatsNVDelegate(VkPhysicalDevice physicalDevice, in VkOpticalFlowImageFormatInfoNV pOpticalFlowImageFormatInfo, ref uint pFormatCount, VkOpticalFlowImageFormatPropertiesNV* pImageFormatProperties);
        
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate VkResult vkCreateOpticalFlowSessionNVDelegate(VkDevice device, in VkOpticalFlowSessionCreateInfoNV pCreateInfo, in VkAllocationCallbacks pAllocator, ref VkOpticalFlowSessionNV pSession);
        
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate void vkDestroyOpticalFlowSessionNVDelegate(VkDevice device, VkOpticalFlowSessionNV session, in VkAllocationCallbacks pAllocator);
        
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate VkResult vkBindOpticalFlowSessionImageNVDelegate(VkDevice device, VkOpticalFlowSessionNV session, VkOpticalFlowSessionBindingPointNV bindingPoint, VkImageView view, VkImageLayout layout);
        
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate void vkCmdOpticalFlowExecuteNVDelegate(VkCommandBuffer commandBuffer, VkOpticalFlowSessionNV session, in VkOpticalFlowExecuteInfoNV pExecuteInfo);
        
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate VkResult vkCreateShadersEXTDelegate(VkDevice device, uint createInfoCount, VkShaderCreateInfoEXT* pCreateInfos, in VkAllocationCallbacks pAllocator, ref VkShaderEXT pShaders);
        
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate void vkDestroyShaderEXTDelegate(VkDevice device, VkShaderEXT shader, in VkAllocationCallbacks pAllocator);
        
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate VkResult vkGetShaderBinaryDataEXTDelegate(VkDevice device, VkShaderEXT shader, ref ulong pDataSize, void* pData);
        
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate void vkCmdBindShadersEXTDelegate(VkCommandBuffer commandBuffer, uint stageCount, VkShaderStageFlags* pStages, in VkShaderEXT pShaders);
        
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate VkResult vkGetFramebufferTilePropertiesQCOMDelegate(VkDevice device, VkFramebuffer framebuffer, ref uint pPropertiesCount, VkTilePropertiesQCOM* pProperties);
        
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate VkResult vkGetDynamicRenderingTilePropertiesQCOMDelegate(VkDevice device, in VkRenderingInfo pRenderingInfo, ref VkTilePropertiesQCOM pProperties);
        
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate VkResult vkSetLatencySleepModeNVDelegate(VkDevice device, VkSwapchainKHR swapchain, in VkLatencySleepModeInfoNV pSleepModeInfo);
        
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate VkResult vkLatencySleepNVDelegate(VkDevice device, VkSwapchainKHR swapchain, in VkLatencySleepInfoNV pSleepInfo);
        
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate void vkSetLatencyMarkerNVDelegate(VkDevice device, VkSwapchainKHR swapchain, in VkSetLatencyMarkerInfoNV pLatencyMarkerInfo);
        
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate void vkGetLatencyTimingsNVDelegate(VkDevice device, VkSwapchainKHR swapchain, ref VkGetLatencyMarkerInfoNV pLatencyMarkerInfo);
        
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate void vkQueueNotifyOutOfBandNVDelegate(VkQueue queue, in VkOutOfBandQueueTypeInfoNV pQueueTypeInfo);
        
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate void vkCmdSetAttachmentFeedbackLoopEnableEXTDelegate(VkCommandBuffer commandBuffer, VkImageAspectFlags aspectMask);
        ...
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate void vkCmdDrawMeshTasksEXTDelegate(VkCommandBuffer commandBuffer, uint groupCountX, uint groupCountY, uint groupCountZ);
        
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate void vkCmdDrawMeshTasksIndirectEXTDelegate(VkCommandBuffer commandBuffer, VkBuffer buffer, ulong offset, uint drawCount, uint stride);
        
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate void vkCmdDrawMeshTasksIndirectCountEXTDelegate(VkCommandBuffer commandBuffer, VkBuffer buffer, ulong offset, VkBuffer countBuffer, ulong countBufferOffset, uint maxDrawCount, uint stride);
