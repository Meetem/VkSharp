...
namespace VkSharp
{
    ...
    public unsafe partial struct VkPhysicalDeviceShaderIntegerDotProductProperties
    {
        ...
        public const VkStructureType StructureTypeId = VkStructureType.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SHADER_INTEGER_DOT_PRODUCT_PROPERTIES;
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static VkPhysicalDeviceShaderIntegerDotProductProperties Create()
        {
            VkPhysicalDeviceShaderIntegerDotProductProperties ret = default;
