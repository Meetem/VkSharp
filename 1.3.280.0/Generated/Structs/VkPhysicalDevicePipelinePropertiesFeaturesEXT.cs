...
namespace VkSharp
{
    ...
    public unsafe partial struct VkPhysicalDevicePipelinePropertiesFeaturesEXT
    {
        ...
        public const VkStructureType StructureTypeId = VkStructureType.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_PIPELINE_PROPERTIES_FEATURES_EXT;
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static VkPhysicalDevicePipelinePropertiesFeaturesEXT Create()
        {
            VkPhysicalDevicePipelinePropertiesFeaturesEXT ret = default;
