...
namespace VkSharp
{
    ...
    // Generated function pointer as structure
    {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public PFN_vkGetDeviceImageMemoryRequirementsKHR(delegate *unmanaged[Cdecl]<VkDevice, in VkDeviceImageMemoryRequirements, ref VkMemoryRequirements2, void> funcPtr)
        {
            this.ptr = funcPtr;
        }
