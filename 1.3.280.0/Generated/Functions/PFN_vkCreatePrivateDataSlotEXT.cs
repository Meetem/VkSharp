...
namespace VkSharp
{
    ...
    // Generated function pointer as structure
    {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public PFN_vkCreatePrivateDataSlotEXT(delegate *unmanaged[Cdecl]<VkDevice, in VkPrivateDataSlotCreateInfo, in VkAllocationCallbacks, ref VkPrivateDataSlot, VkResult> funcPtr)
        {
            this.ptr = funcPtr;
        }
