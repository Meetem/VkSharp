...
namespace VkSharp
{
    public unsafe partial struct VkInstance
    {
        ...
        {
            var f = new PFN_vkDestroySurfaceKHR(VkLoader.GetFunction(212));
        ...
        {
            var f = new PFN_vkCreateDisplayPlaneSurfaceKHR(VkLoader.GetFunction(232));
        ...
        {
            var f = new PFN_vkEnumeratePhysicalDeviceGroupsKHR(VkLoader.GetFunction(260));
            return f.Call(this, ref pPhysicalDeviceGroupCount, pPhysicalDeviceGroupProperties);
        }
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        ...
        {
            var f = new PFN_vkCreateDebugReportCallbackEXT(VkLoader.GetFunction(356));
        ...
        {
            var f = new PFN_vkDestroyDebugReportCallbackEXT(VkLoader.GetFunction(357));
        ...
        {
            var f = new PFN_vkDebugReportMessageEXT(VkLoader.GetFunction(358));
        ...
        {
            var f = new PFN_vkCreateDebugUtilsMessengerEXT(VkLoader.GetFunction(404));
        ...
        {
            var f = new PFN_vkDestroyDebugUtilsMessengerEXT(VkLoader.GetFunction(405));
        ...
        {
            var f = new PFN_vkSubmitDebugUtilsMessageEXT(VkLoader.GetFunction(406));
        ...
        {
            var f = new PFN_vkCreateHeadlessSurfaceEXT(VkLoader.GetFunction(455));
            return f.Call(this, in pCreateInfo, in pAllocator, ref pSurface);
        }
    }
}
