...
namespace VkSharp
{
    ...
    {
        public const bool IsDispatchable = false;
        public static VkPrivateDataSlotEXT Null => default;
        public bool IsNull => value == 0;
        public ulong value;
        
        public bool Equals(VkPrivateDataSlotEXT other) => value == other.value;
        ...
        public static bool operator ==(VkPrivateDataSlotEXT lhs, VkPrivateDataSlotEXT rhs) => lhs.value == rhs.value;
        public static bool operator !=(VkPrivateDataSlotEXT lhs, VkPrivateDataSlotEXT rhs) => lhs.value != rhs.value;
    }
