...
namespace VkSharp
{
    ...
    {
        public delegate *unmanaged[Cdecl]<VkCommandBuffer, in VkRenderingInfoKHR, void> ptr;
        public void* Pointer
        {
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            get => (void*)this.ptr;
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            set => this.ptr = (delegate *unmanaged[Cdecl]<VkCommandBuffer, in VkRenderingInfoKHR, void>)value;
        }
        
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public PFN_vkCmdBeginRenderingKHR(void *value)
        {
            this.ptr = (delegate *unmanaged[Cdecl]<VkCommandBuffer, in VkRenderingInfoKHR, void>)value;
        }
        
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public PFN_vkCmdBeginRenderingKHR(delegate *unmanaged[Cdecl]<VkCommandBuffer, in VkRenderingInfoKHR, void> funcPtr)
        {
            this.ptr = funcPtr;
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void Call(VkCommandBuffer commandBuffer, in VkRenderingInfoKHR pRenderingInfo)
        {
