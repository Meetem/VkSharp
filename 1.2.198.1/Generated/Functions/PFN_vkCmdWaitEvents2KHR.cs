...
namespace VkSharp
{
    ...
    {
        public delegate *unmanaged[Cdecl]<VkCommandBuffer, uint, VkEvent*, in VkDependencyInfoKHR, void> ptr;
        public void* Pointer
        {
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            get => (void*)this.ptr;
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            set => this.ptr = (delegate *unmanaged[Cdecl]<VkCommandBuffer, uint, VkEvent*, in VkDependencyInfoKHR, void>)value;
        }
        
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public PFN_vkCmdWaitEvents2KHR(void *value)
        {
            this.ptr = (delegate *unmanaged[Cdecl]<VkCommandBuffer, uint, VkEvent*, in VkDependencyInfoKHR, void>)value;
        }
        
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public PFN_vkCmdWaitEvents2KHR(delegate *unmanaged[Cdecl]<VkCommandBuffer, uint, VkEvent*, in VkDependencyInfoKHR, void> funcPtr)
        {
            this.ptr = funcPtr;
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void Call(VkCommandBuffer commandBuffer, uint eventCount, VkEvent* pEvents, in VkDependencyInfoKHR pDependencyInfos)
        {
