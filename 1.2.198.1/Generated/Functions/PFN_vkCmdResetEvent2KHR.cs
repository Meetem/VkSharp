...
namespace VkSharp
{
    ...
    {
        public delegate *unmanaged[Cdecl]<VkCommandBuffer, VkEvent, VkPipelineStageFlags2KHR, void> ptr;
        public void* Pointer
        {
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            get => (void*)this.ptr;
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            set => this.ptr = (delegate *unmanaged[Cdecl]<VkCommandBuffer, VkEvent, VkPipelineStageFlags2KHR, void>)value;
        }
        
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public PFN_vkCmdResetEvent2KHR(void *value)
        {
            this.ptr = (delegate *unmanaged[Cdecl]<VkCommandBuffer, VkEvent, VkPipelineStageFlags2KHR, void>)value;
        }
        
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public PFN_vkCmdResetEvent2KHR(delegate *unmanaged[Cdecl]<VkCommandBuffer, VkEvent, VkPipelineStageFlags2KHR, void> funcPtr)
        {
            this.ptr = funcPtr;
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void Call(VkCommandBuffer commandBuffer, VkEvent _event, VkPipelineStageFlags2KHR stageMask)
        {
