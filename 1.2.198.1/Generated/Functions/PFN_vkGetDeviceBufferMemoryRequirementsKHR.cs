...
namespace VkSharp
{
    ...
    {
        public delegate *unmanaged[Cdecl]<VkDevice, in VkDeviceBufferMemoryRequirementsKHR, ref VkMemoryRequirements2, void> ptr;
        public void* Pointer
        {
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            get => (void*)this.ptr;
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            set => this.ptr = (delegate *unmanaged[Cdecl]<VkDevice, in VkDeviceBufferMemoryRequirementsKHR, ref VkMemoryRequirements2, void>)value;
        }
        
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public PFN_vkGetDeviceBufferMemoryRequirementsKHR(void *value)
        {
            this.ptr = (delegate *unmanaged[Cdecl]<VkDevice, in VkDeviceBufferMemoryRequirementsKHR, ref VkMemoryRequirements2, void>)value;
        }
        
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public PFN_vkGetDeviceBufferMemoryRequirementsKHR(delegate *unmanaged[Cdecl]<VkDevice, in VkDeviceBufferMemoryRequirementsKHR, ref VkMemoryRequirements2, void> funcPtr)
        {
            this.ptr = funcPtr;
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void Call(VkDevice device, in VkDeviceBufferMemoryRequirementsKHR pInfo, ref VkMemoryRequirements2 pMemoryRequirements)
        {
