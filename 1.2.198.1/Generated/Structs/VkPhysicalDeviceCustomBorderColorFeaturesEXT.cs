...
namespace VkSharp
{
    ...
    public unsafe partial struct VkPhysicalDeviceCustomBorderColorFeaturesEXT
    {
        ...
        public const VkStructureType StructureTypeId = VkStructureType.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_CUSTOM_BORDER_COLOR_FEATURES_EXT;
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static VkPhysicalDeviceCustomBorderColorFeaturesEXT Create()
        {
            VkPhysicalDeviceCustomBorderColorFeaturesEXT ret = default;
